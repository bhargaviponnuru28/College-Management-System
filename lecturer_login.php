...
<head>
  <meta charset="UTF-8">
  <title>UCMO LECTURER LOGIN</title>
...
<div class="cont">
  <div class="form sign-in">
      <form method="post" id="admin_login" action="lecturer_login.php">
        ...
        <label>
        <span>Email</span>
          <input type="email" name="email" id="admin_signin_email" placeholder="sung@ucmo.edu" required pattern="(.+@gmail.com)|(.+@ucmo.edu)"
          title="Please enter an email with UCMO/mail extension"><br>
      </label>
      <label>
          <span>Password</span>
