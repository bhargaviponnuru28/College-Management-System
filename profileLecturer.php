...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="lecturer_index.php">University of Central Missouri</a>
      ...
      <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="myprofile" role="tabpanel" aria-labelledby="myprofile-tab">
          <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="https://marvel-b1-cdn.bc0a.com/f00000000155119/www.ucmo.edu/college-of-health-science-and-technology/school-of-computer-science-and-mathematics/computer-science-and-software-engineering/faculty/sung.jpg" alt="Card image cap">
            <div class="card-body">
              <?php
