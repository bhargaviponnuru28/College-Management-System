            ...
            <div class="card-body">
                ...
                <form method="post" action="faculty.php" > 
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input name="book_name" type="text" class="form-control" id="inlineFormInputName1" placeholder="Ex: 'Advanced Web Applications'">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inlineFormInputName2" class="col-sm-2 col-form-label">Author</label>
                      <div class="col-sm-10">
                        <input name="book_author" type="text" class="form-control" id="inlineFormInputName2" placeholder="Ex: 'Dr. Sung'">
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-sm-10">
